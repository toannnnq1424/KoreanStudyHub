...
public class ExcelParser {
    ...
    static {
        // Reject xlsx files with abnormally high compression ratio (zip bomb defense).
        // POI default 0.01 = 100x ratio max. Tighten to 0.005 = 200x — still permits
        // legitimate spreadsheets but blocks crafted bombs (worst real-world ratio ~10x).
        ZipSecureFile.setMinInflateRatio(0.005);
        // Cap any single decompressed entry at 50MB; our 2MB upload cap × ZIP ratio
        // means a legitimate file's largest entry is well under this.
