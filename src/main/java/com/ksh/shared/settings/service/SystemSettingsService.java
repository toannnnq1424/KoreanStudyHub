package com.ksh.shared.settings.service;
 ...
 * <ul>
 *   <li>{@link com.ksh.admin.settings.service.EmailSettingsService#save} —
 *       evicts the {@code SMTP} entry.</li>
 *   <li>{@link com.ksh.admin.settings.service.OauthSettingsService#save} —
