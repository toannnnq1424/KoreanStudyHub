...
class SpeakingPromptRulesTest {
    ...
    void promptRulesIncludeAllowedRubricPolicyAndEvidenceConstraints() {
        ...
        assertThat(prompt)
                ...
                .contains("backend không đoán vị trí bằng String.indexOf")
                .contains("occurrence_index/occurrence_count")
                .contains("source_hash SHA-256")
                .contains("Điểm tối đa không được đồng thời có finding needs_improvement")
