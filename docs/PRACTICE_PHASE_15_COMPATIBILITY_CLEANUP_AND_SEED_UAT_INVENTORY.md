...
| `P15-KEEP-05` | `KEEP` | Phase 13D explanation artifact, question-version binding, durable task, retry, reconciliation and read-only result lifecycle introduced by V28. |
