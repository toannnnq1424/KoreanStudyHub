...
class PracticeAim8CompatibilityStaticContractTest {
    ...
    @Test
    void migrationChainIsContinuousThroughV111AndHistoricalBytesStayLockedThroughV85()
            throws Exception {
