-- Invite storage and routes are gone. Normalize historical enrollment source
-- values so neither CODE nor LINK remains part of the product vocabulary.
UPDATE enrollments SET joined_via = 'REQUEST' WHERE joined_via IN ('CODE', 'LINK');
