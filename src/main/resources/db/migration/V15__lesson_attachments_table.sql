-- ksh-4.0c — Lesson attachments table.
--
-- Producer for ksh-4.3 (student PDF viewer) and ksh-4.4 (student file
...
-- Drop existing lesson_attachments table from V1 schema
