package com.ksh.features.classes.imports.session;
 ...
 *
 * <p>The session is created by
 * {@link com.ksh.features.classes.imports.service.ImportStudentsService#previewUpload}
 * after parsing and validation finish, stored in {@link ImportSessionStore},
 * and later replayed by
 * {@link com.ksh.features.classes.imports.service.ImportStudentsService#confirmImport}
 * when the lecturer confirms the operation. Sessions expire after 10 minutes;
 * an expired session must be re-uploaded.
 */
